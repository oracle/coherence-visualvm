...
NOTE: Support for versions 3.7 and older is now deprecated and no longer supported. The plugin may still work with these older versions, but is not guaranteed to continue.
