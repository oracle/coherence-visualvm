...
The Plugin ideal tool for monitoring and managing Coherence clusters during the development and testing lifecycle and supports connecting to both
...
[source,shell]
----
$ git clone https://github.com/coherence-community/visualvm-coherence.git
----
...
1. Unzip the NetBeans Platform 13
+
[source,shell]
----
$ cd visualvm
