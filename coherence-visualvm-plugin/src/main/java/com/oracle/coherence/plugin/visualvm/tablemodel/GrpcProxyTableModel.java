...
/**
 * A model for holding gRPC proxy server data.
 *
 * @author tam  2022.02.04
 * @since  1.3.0
 */
public class GrpcProxyTableModel
     ...
     */
    public GrpcProxyTableModel(String[] asColumns)
        {
        super(asColumns);
        }
    ...
    private static final long serialVersionUID = -6125785231857300336L;
    }
