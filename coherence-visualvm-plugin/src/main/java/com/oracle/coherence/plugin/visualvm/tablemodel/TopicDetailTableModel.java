...
/**
 * A model for holding topic detail data.
 *
 * @author tam  2022.12.14
 * @since  1.6.0
 */
public class TopicDetailTableModel
     ...
     */
    public TopicDetailTableModel(String[] asColumns)
        {
        super(asColumns);
        }
    ...
    private static final long serialVersionUID = 889398832931509048L;
    }
