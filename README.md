...
7. Right-Click on the connection and select `Open`. The Coherence tab will be displayed.
   ...
   If you wish to secure access to the REST endpoints or via JMX, please refer to either the [https://docs.oracle.com/en/middleware/standalone/coherence/14.1.1.2206/index.html](Coherence Documentation) or relevant JMX security documentation.
